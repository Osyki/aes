...
round10_subkey = 0xb77e0cc0760002712ab4539880aacca6
round10_subkey_bytes = round10_subkey.to_bytes(16, 'big')

answer = reverse_key_schedule(round10_subkey_bytes, 10)
print(f'Answer: {answer}')
answer_hex = answer.hex()
print(f'Answer in hex: 0x{answer_hex}')